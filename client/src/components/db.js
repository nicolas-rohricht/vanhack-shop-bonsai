export const products = [
  ...
  { id: 1, name: 'Nike T-shirt', selected: false, size: 'M', color: 'white', brand: 'Nike', brandID: 1, price: 19.90, quantity: 2, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...", merchant: 'Best Store', merchantID: 1, image: 'https://picsum.photos/300/?random' },
  { id: 2, name: 'Adidas Shorts', selected: false, size: 'L', color: 'black', brand: 'Adidas', brandID: 2, price: 24.90, quantity: 7, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...",merchant: 'Buy Here Store', merchantID: 2, image: 'https://picsum.photos/300/?random' },
  { id: 3, name: 'Adidas Glove', selected: false, size: 'S', color: 'blue', brand: 'Adidas', brandID: 2, price: 39.90, quantity: 5, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...",merchant: '100% Store', merchantID: 3, image: 'https://picsum.photos/300/?random' },
  { id: 4, name: 'Smt Skate', selected: false, size: 'L', color: 'yellow', brand: 'Smt', brandID: 3, price: 79.90, quantity: 4, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...",merchant: 'Store for you!', merchantID: 4, image: 'https://picsum.photos/300/?random' },
  { id: 5, name: 'Nike Sport Pant', selected: false, size: 'S', color: 'white', brand: 'Nike', brandID: 1, price: 26.90, quantity: 9, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...", merchant: 'Best place', merchantID: 5, image: 'https://picsum.photos/300/?random' },
  { id: 6, name: 'Adidas Runner Tennis', selected: false, size: 'M', color: 'pink', brand: 'Adidas', brandID: 2, price: 49.90, quantity: 10, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...", merchant: 'Clark Place', merchantID: 6, image: 'https://picsum.photos/300/?random' },
  { id: 7, name: 'Nike Tennis', selected: false, size: 'S', color: 'white', brand: 'Nike', brandID: 1, price: 35.90, quantity: 3, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...",merchant: 'Best Store', merchantID: 1, image: 'https://picsum.photos/300/?random' },
  { id: 8, name: 'FILA Roller', selected: false, size: 'M', color: 'blue', brand: 'FILA', brandID: 4, price: 89.90, quantity: 7, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...",merchant: 'Buy Here Store', merchantID: 2, image: 'https://picsum.photos/300/?random' },
  { id: 9, name: 'Adidas T-shirt', selected: false, size: 'S', color: 'white', brand: 'Adidas', brandID: 2, price: 31.90, quantity: 14, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...",merchant: '100% Store', merchantID: 3, image: 'https://picsum.photos/300/?random' },
  { id: 10, name: 'Nike Shorts', selected: false, size: 'L', color: 'white', brand: 'Nike', brandID: 1, price: 19.90, quantity: 4,description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...", merchant: 'Store for you!', merchantID: 4, image: 'https://picsum.photos/300/?random' },
  { id: 11, name: 'Adidas Sport Pant', selected: false, size: 'S', color: 'black', brand: 'Adidas', brandID: 2, price: 47.90, quantity: 2, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...",merchant: 'Best place', merchantID: 5, image: 'https://picsum.photos/300/?random' },
  { id: 12, name: 'Pop Runner Tennis', selected: false, size: 'S', color: 'white', brand: 'Pop', brandID: 5, price: 41.90, quantity: 3,description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...", merchant: 'Clark Place', merchantID: 6, image: 'https://picsum.photos/300/?random' },
  ...
  { id: 14, name: 'Basic Tennis', selected: false, size: 'S', color: 'white', brand: 'Basic', brandID: 7, price: 29.90, quantity: 0, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...",merchant: 'Buy Here Stor', merchantID: 2, image: 'https://picsum.photos/300/?random' },
  { id: 15, name: 'Master Bag', selected: false, size: 'L', color: 'white', brand: 'Master', brandID: 8, price: 59.90, quantity: 7, description: "Excepteur non Lorem aliqua esse irure veniam elit labore culpa velit n...",merchant: 'Store for you!', merchantID: 4, image: 'https://picsum.photos/300/?random' }]
